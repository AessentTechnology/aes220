...
DLLEXPORT aes220_Dev::aes220_Dev() {
...
DLLEXPORT int aes220_Dev::Open(int idx, int vbs) { 
  int rv = 99;
...
DLLEXPORT int aes220_Dev::Open(int vid, int pid, int idx, int vbs) { 
  int rv = 99;
...
DLLEXPORT int aes220_Dev::Close() { 
  int rv = 99;
  rv = aes220_ptr->close_Device();
  return rv;
} 

DLLEXPORT int aes220_Dev::PipeOut(uint8_t *buf_ptr, uint32_t bufSize, uint8_t channelAddress) {
  int rv = 99;
  rv = aes220_ptr->pipe_Out(buf_ptr, bufSize, channelAddress);
  return rv;
}

DLLEXPORT int aes220_Dev::PipeIn(uint8_t *buf_ptr, uint32_t bufSize, uint8_t channelAddress) {
  int rv = 99;
  rv = aes220_ptr->pipe_In(buf_ptr, bufSize, channelAddress);
  return rv;
}

DLLEXPORT int aes220_Dev::AssertSoftReset()
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::ClearSoftReset()
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::ReadI2C(uint8_t deviceAddress, uint8_t *data, uint16_t dataLength)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::WriteI2C(uint8_t deviceAddress, uint8_t *data, uint16_t dataLength)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::CombinedI2C(uint8_t deviceAddress,
...
DLLEXPORT int aes220_Dev::Turn3V3On()
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::Turn3V3Off()
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::SetBoardInfo(const uint8_t *boardInfo)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::GetBoardInfo(const uint8_t * boardInfo)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::GetFirmwareInfo(uint8_t * firmwareInfo_ptr)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::ProgramMCRAM(const char * file_ptr)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::ProgramMCEEPROM(const char * file_ptr)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::ConfigureFPGA(const char * file_ptr)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::ProgramFPGA(const char * file_ptr)
{
  int rv = 99;
...
DLLEXPORT int aes220_Dev::EraseFPGA()
{
  int rv = 99;
