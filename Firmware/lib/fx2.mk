# !!! Hard coded path to utils for working around file permissions on USB key
# Revert to fx2.mk.bak_20130110 afterwards
...
$(BASENAME).iic: $(BASENAME).ihx
	~/Software/utils/ihx2iic.py -c 0x00 -v $(VID) -p $(PID) $< $@
